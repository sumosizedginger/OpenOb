...
`;
  ...
  it('sanitizes dangerous HTML in previews (SECURITY)', () => {
    const dangerous = `<p>Safe text</p><script>alert('pwned')</script><img src="x" onerror="alert(1)" /><a href="javascript:steal()">Click</a>`;
