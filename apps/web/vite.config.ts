    ...
    alias: [
      {
        ...
        replacement: path.resolve(__dirname, '../../packages/vault/src/node-fs-storage-browser-stub.ts'),
      },
      ...
      { find: '@okw/markdown', replacement: path.resolve(__dirname, '../../packages/markdown/src') },
