      ...
      <div className="modal-dialog" onClick={(e) => e.stopPropagation()} style={{ maxWidth: '640px' }}>
        ...
        <div className="modal-body">
          <p style={{ marginBottom: '14px' }}>
            The file <strong>"{path}"</strong> was modified outside this editor (or concurrently). To protect your
            data from being silently overwritten, please choose how to resolve this conflict:
          </p>
        ...
        <div className="modal-footer">
          ...
          <button className="btn btn-primary" style={{ backgroundColor: 'var(--status-danger)', borderColor: 'var(--status-danger)' }} onClick={onForceOverwrite}>
